                ...
                >
                    <div className="max-w-xl lg:max-w-3xl">
                        ...
                        <h1 className="mt-6 text-2xl font-bold text-gray-900 sm:text-3xl md:text-4xl">
                            Добро пожаловать обратно в Well-being Platform! 💻
                        </h1>
                        ...
                        <form onSubmit={handleSubmit} className="mt-8 grid grid-cols-6 gap-6">
                            <div className="col-span-6">
                                ...
                                <input
                                    className="mt-1 w-80 rounded-md border-gray-200 bg-white text-sm text-gray-700 shadow-sm"
                                    id="Email"
                                    name="email"
                                    type="email"
                            ...
                            <div className="col-span-6 sm:flex sm:items-center sm:gap-4">
                                <button className="inline-block shrink-0 rounded-md border border-blue-600 bg-blue-600 px-12 py-3
                                     text-sm font-medium text-white transition hover:bg-transparent hover:text-blue-600
